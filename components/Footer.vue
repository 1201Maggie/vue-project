    ...
    <footer class="footer">
        <div class="foot-con">
            <div class="foot-con_2">
                <router-link to="/home" class="home" active-class="active" tag="span">
                    <a href="javascript:;" class="active">
                        <i class="navIcon home"></i>
                        <span class="text">首页</span>
                    </a>
                </router-link>
                <router-link to="/detail" class="detail" tag="span">
                    <a href="javascript:;">
                        <i class="navIcon sort"></i>
                        <span class="text">分类</span>
                    </a>
                </router-link>
                <router-link to="/buycar" class="buycar" tag="span">
                    <a href="javascript:;">
                        <i class="navIcon shop"></i>
                        <span class="text">购物车</span>		
                    </a>
                </router-link>   
                <router-link to="/user" class="user" tag="span">
                    <a href="javascript:;" >
...
.foot-con .navIcon{width: 28px; height: 28px; margin-top:3px; display: inline-block; background:url(../assets/images/icon.png) no-repeat; background-size: 280px 90px;}
