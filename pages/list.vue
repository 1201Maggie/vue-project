    ...
    <div class="list">
		...
		<header class="header">
			<div class="fix_nav">
				<div style="max-width:768px;margin:0 auto;background:#000;position: relative;">
					...
					<div class="tit" style="width:100%;">商品详细</div>
				</div>
			</div>	
		</header>
				...
				<div id="slide"> 
					...
					<div class="bd">
						<div class="tempWrap" style="overflow:hidden; position:relative;">
							<ul style="position: relative; overflow: hidden; padding: 0px; margin: 0px; transition-duration: 200ms;">
								<li style="display: table-cell; vertical-align: middle; max-width: 768px;">
									<a href="#"><img style="max-width:100vw;max-height:80vw;margin:auto;" src="../assets/img/53698282-4ff7-4daa-bb4c-4bcaa14b00fc.jpg"></a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="fixed-foot">
			<div class="fixed_inner">
				<a class="btn-fav" href="javascript:;" onclick="addInterest(this,'663');">
					<i class="i-fav"></i><span>收藏</span>
				</a>
				<router-link to="/buyCar">
					<a class="cart-wrap" href="javascript:;">
						<i class="i-cart"></i>
						<span>购物车</span>
				...
				<router-link to="/buyCar">
					<div class="buy-btn-fix">
						<a class="btn btn-info btn-cart"  onclick="addShopCart();" href="javascript:;">加入购物车</a>
						<a class="btn btn-danger btn-buy" onclick="buyNow();" href="javascript:;">立即购买</a>
					</div>
				</router-link>
			</div>
		</div>
